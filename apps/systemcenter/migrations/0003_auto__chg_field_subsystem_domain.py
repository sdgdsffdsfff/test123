...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubSystem.domain'
        db.alter_column(u'systemcenter_subsystem', 'domain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['networkcenter.DomainRecord']))

    def backwards(self, orm):

        # Changing field 'SubSystem.domain'
        db.alter_column(u'systemcenter_subsystem', 'domain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['networkcenter.Domain']))
    ...
    models = {
        ...
        u'systemcenter.subsystem': {
            ...
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['networkcenter.DomainRecord']", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
