...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServerPool.is_vrt'
        db.add_column(u'systemcenter_serverpool', 'is_vrt',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ServerPool.is_vrt'
        db.delete_column(u'systemcenter_serverpool', 'is_vrt')
