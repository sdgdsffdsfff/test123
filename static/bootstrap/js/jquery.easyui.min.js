...
cc.push("<span class=\"glyphicon glyphicon-folder-close"+(item.iconCls?item.iconCls:"")+"\"></span>");
}else{
...
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"glyphicon glyphicon-minus "+(item.iconCls?item.iconCls:"")+"\"></span>");
_1a2=true;
}
}
if(opts.checkbox){
...
if(row.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
cc.push("<span class=\"glyphicon glyphicon-folder-close"+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
if(row.children&&row.children.length){
cc.push("<span class=\"tree-hit tree-expanded\"></span>");
cc.push("<span class=\"glyphicon glyphicon-folder-close"+(row.iconCls?row.iconCls:"")+"\"></span>");
...
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"glyphicon glyphicon-minus "+(row.iconCls?row.iconCls:"")+"\"></span>");
}
}
